...
1. Complete the form, checking the _Create new company_ checkbox, and press Agree

![](../../images/image-784.png)

1. Browse to the XMPro Subscription Manager website

2. Log in using the XMPro credentials (<admin@xmpro.onxmpro.com>)
...
1. Open the Companies page from the left-hand menu

![](../../images/companies1.png)

1. Click the Company you have just requested to be added (in this example, "Company")

2. Click the Subscription Requests button in the command bar, click the request and click Save
...
1. Change the Product to App Designer and request another license
...
1. Click Add on the Subscriptions page and repeat the steps above for the App Designer product
...
1. Repeat the above steps for the App Designer.
