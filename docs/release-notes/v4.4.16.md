...
<table><thead><tr><th width="155">Change Type</th><th width="250">Name</th><th>Description</th></tr></thead><tbody><tr><td>Enhancement</td><td><a href="https://xmpro.gitbook.io/integrations/meta/">Meta Action Agent v1.10</a></td><td><span style="color:red;">Breaking change</span> to support Git Repo, self-packaging, log outputs, batch processing/output.</td></tr><tr><td>Enhancement</td><td><a href="https://xmpro.gitbook.io/integrations/rest-api-connector/">REST API Connector v1.01</a></td><td>Support content type <code>application/x-www-form-urlencoded</code>, commonly used in Azure for OAuth2/token authentication requests.</td></tr></tbody></table>
