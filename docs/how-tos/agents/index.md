...
An Agent is a reusable object which forms the building block of a [Data Stream](../../concepts/data-stream/index.md). When a number of Agents are connected together, a Data Stream is formed.
