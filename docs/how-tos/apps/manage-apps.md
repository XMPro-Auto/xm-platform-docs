...
![Categories dashboard showing app categories](../../images/apps/apps-1.png)
...
![Applications list grouped by category](../../images/apps/apps-2.png)
...
![Applications dashboard for a category](../../images/apps/apps-3.png)
...
![Example of an application](../../images/apps/apps-4.png)
...
![New Application button in the left menu](../../images/apps/apps-5.png)
...
![Edit page for an application](../../images/apps/apps-6.png)
...
![Template selection for new application](../../images/apps/apps-7.png)

1. Enter the name and description of the new App.
2. Choose the category the app belongs to.
3. Upload the icon. Sample icons can be found in the [Icon Library](../../resources/icon-library.md).
4. Choose between Light and Dark themes.
5. You may also include tags from the drop-down that opens when you click on the field - or type a new value and press _Enter_.
6. Choose the layout of the Landing (Main) page.
7. Click on _Save_.

![New application properties form](../../images/apps/apps-8.png)
...
![Applications dashboard showing edit button](../../images/apps/apps-3.png)

1. Click on _Properties_.
2. Click on _Delete_.
3. Confirm that you want to delete the Application.

![Delete application confirmation](../../images/apps/apps-10.png)
...
![Importing an app with data stream connections](../../images/apps/apps-11.png)
