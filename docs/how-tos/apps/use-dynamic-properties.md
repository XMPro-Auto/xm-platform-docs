...
![Screenshot showing the dynamic properties icon (letter A) in the block properties panel](../../images/apps/dynamic-properties/dynamic-props-icon.png)

![Screenshot demonstrating binding a property to the device type value in the dynamic properties panel](../../images/apps/dynamic-properties/dynamic-props-binding.png)
