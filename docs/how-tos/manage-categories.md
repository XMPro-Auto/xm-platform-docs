...
A Category is a container that groups related [Data Streams](../concepts/data-stream/index.md) and [Applications](../concepts/application/index.md), which are shared between core XMPro Products to provide a homogenous environment.
