...
![Uploading a new agent version through the Versions section](../../images/data-streams/agents/agents-8.png)
...
To upgrade the version of an Agent in a stream, open your stream and select the Agent.
...
![Steps to upgrade an agent version in a data stream](../../images/data-streams/agents/upgrade-agent-version-steps.png)
