...
> [!WARNING]
> Stream metric components ([Stream Load](#stream-load) and [Stream Errors](#stream-errors)) do affect performance. See the [Data Stream Designer Settings](../manage-site-settings.md#enable-stream-metrics) article for more information on how to toggle this feature on and off.
...
![Started On status indicator showing stream host start status](../../images/data-streams/Started On.png)
...
![Stream Load card showing data processing metrics](../../images/data-streams/Stream Load.png)
...
![Stream Errors card showing error count metrics](../../images/data-streams/stream-error.png)
...
![Stream Hosts per Collection showing active host count](../../images/data-streams/logs-collection.png)
