...
![View Data Stream Logs](../../images/logs-view-logs.png)

You can also maximize the grid to view the data more clearly.

![Maximizing the Grid - Step 1](../../images/logs-max1.png)

![Maximizing the Grid - Step 2](../../images/logs-max2.png)

To view logs within a specific time range, adjust the timeline slider above the grid.

![Timeline Slider for Logs](../../images/logs-timeline-2.png)
...
![Refreshing Logs](../../images/logs-refresh.png)
...
![Filtering Logs by Level](../../images/logs-filter.png)
...
![Exporting Logs](../../images/logs-export2.png)
