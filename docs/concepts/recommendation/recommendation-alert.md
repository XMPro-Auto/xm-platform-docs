...
![Search Recommendation Alerts](../../images/search-reco-alerts.png)
...
![Fig 4: Recommendation Alert page](../../images/alert-basic-information.png)

### Headline

The headline of the Alert. Generated by the [Rule Headline](rule.md#alert-headline--description).

### Recommendation Details

A paragraph on the details of the Alert. Generated by the [Rule Description](rule.md#alert-headline--description).

### Event Data

The data received by the Data Stream. If "[Log Data On All Occurrences](rule.md#log-data-on)" is checked in the Rule, this data will be updated as new data is received.
...
![Fig 5: Assign a recommendation alert](../../images/alert-reassign-popup.png)
...
![Alert Form](../../images/alert-form.png)
...
![Alert Triage Instructions](../../images/alert-triage-instruction.png)
...
![Alert Discussion](../../images/alert-discussion.png)
...
![Alert Discussion Search and Send](../../images/alert-discussion-search-and-send-message.png)
...
![Alert Discussion Mention User](../../images/alert-discussion-box-mention-user.png)
