...
The conditions that gave rise to the alert, i.e. the data received by the Data Stream. If "[Log Data On All Occurrences](../../concepts/recommendation/rule.md#actions-on-the-rule)" is checked in the Rule, this data will be updated as new data is received.

![Event Data for an Alert](../../images/alert-event-data.png)
_Fig 1: Event Data for an Alert_
